  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        magic: "bg-gradient-magic text-magic-foreground hover:shadow-magic hover:scale-105 border-0",
        trust: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-105 shadow-soft",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:scale-105 shadow-soft",
        outline: "border-2 border-primary bg-background text-primary hover:bg-primary/5 hover:scale-105",
